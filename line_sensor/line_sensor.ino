 ...
 {
  int i, line_index;
  int sum = 0;  //line sensor에서 불이 들어온 갯수
  ...
  //line_sensor[0]  line_sensor[1]   line_sensor[2]  line_sensor[3]  line_sensor[4]   line_sensor[5]
  //    -4         -3       -2       -1        0         1       2           3        4  
 ...
 void line_following(int line_index)
 {
  switch(line_index)
  {
  case -4:  motor_R_control(120); motor_L_control(110);
          break;
  case -3:
          break;
  case -2:
  ...
  case  0:   
          break;
  case  1:  motor_R_control(80); motor_L_control(110);
          break;
  case  2:
          break;
  case  3:
...
#define WALL_GAP_DISTANCE_HALF 300 //mm  단위
...
for(i=0; i<5; i++)
{
  pinMode(line_sensor_pin[i], INPUT);  //line sensor pin을 입력으로 설정
}
