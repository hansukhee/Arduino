...
{
if((left_sonar>= 0)&&(left_sonar <=200)&&(right_sonar>= 0)&&(right_sonar <=200))
  {
    maze_status = 1;
   ...
   else if((right_sonar>= 0)&&(right_sonar <=200)&&(front_sonar>= 0)&&(front_sonar <=200))
  {
   ...
   else if((left_sonar>= 0)&&(left_sonar <=200)&&(left_sonar>= 0)&&(left_sonar <=200)&&(front_sonar>= 0)&&(front_sonar <=200))
  {
    maze_status = 4;
